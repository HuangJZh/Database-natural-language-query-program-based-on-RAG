...
```
(qwen3) PS D:\Qwen\Qwen3\rag_system> python rag_chat_system.py
🚀 初始化数据库对话系统...
============================================================
📝 创建数据库文档...
✅ 数据库连接成功
✅ 数据库文档已生成到 D:/Qwen/Qwen3/rag_system/enhanced_database_docs

🔧 构建RAG系统...
加载bge-small-zh-v1.5嵌入模型...
加载Qwen3模型: D:/Qwen/Qwen/Qwen3-4B
...
================================================================================
📝 用户问题: 查询十个最贵的商品
🔍 生成的SQL: SELECT product_name, price 
FROM products
ORDER BY price DESC
LIMIT 10
✅ 查询成功，返回 10 行结果
...
📊 查询结果:
使用RAG: 是
SQL查询: SELECT product_name, price
FROM products
ORDER BY price DESC
LIMIT 10
...
📋 查询结果 (10 行):
         product_name   price
Canon Headphones 2001 1999.02
       HP Camera 1757 1997.40
  Sony Smartphone 244 1997.24
Canon Headphones 1616 1995.45
 Canon Headphones 351 1992.44
    Apple Tablet 2280 1991.47
        LG Camera 635 1988.92
   LG Headphones 2110 1988.64
     Nikon Laptop 704 1986.76
   Samsung Tablet 672 1977.90
...
================================================================================
📝 用户问题: 查询十个最贵的商品
🔍 生成的SQL: SELECT... FROM... ORDER BY... LIMIT 10
❌ 查询执行失败: 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '... FROM... ORDER BY... LIMIT 10' at line 1

📊 查询结果:
使用RAG: 否
SQL查询: SELECT... FROM... ORDER BY... LIMIT 10
❌ 错误: 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '... FROM... ORDER BY... LIMIT 10' at line 1
```
